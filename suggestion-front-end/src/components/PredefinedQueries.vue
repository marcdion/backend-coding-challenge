...
export default {
  ...
  methods: {
    predefinedQuery1(){
        this.$emit("predefinedQuery1")
    },
    predefinedQuery2(){
        this.$emit("predefinedQuery2")
    },
    predefinedQuery3(){
